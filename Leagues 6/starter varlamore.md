...
- Visit the General Store and buy any essentials you're missing
  - Make sure you have: bucket, shears, chisel, knife, hammer, tinderbox
- Buy some silk from the silk trader and sell it back to him
- Cry near a child
- Steal some bread from the bakery stall in the Bazaar
- Buy an onion from the food shop (north of the estate agent) and eat it
  - Alternatively you can do this task later without spending 3gp
- Fill your bucket at the water pump slightly to the north
- Go to the pub east of the Bazaar and buy a Stew (20gp), some Moonlite (15gp), a Meat Pie (15gp), and a Cup of Tea (10gp)
  - If at any point you are at 4 or less HP, take a bite of the meat pie (it's a task to eat something that heals 6 or more HP)
- Drink the Moonlite
- Head south of the pub
- Drink from the bird bath
- Pet Xolo
- Activate a prayer next to the altar
- Salute next to the statue of Quoatlos in the temple
- Buy an apron and a non-purple cape from the clothing shop south-west of the bazaar and equip it
  - The apron will be used for a later task to cook something with an apron, so just keep it equipped until then
...
- Rake the flower patch
- Pick 6 potatoes (partial task)
- Milk the dairy buffalo
- Shear an alpaca (keep hold of the wool)
- Head west, chopping trees as you go for Woodcutting exp
  - Burn a log
  - Fletch a log into arrow shafts
  - There is a task to fletch 1000 arrow shafts, I'd suggest working towards this
...
- Head east
- Sit near a stolen cabbage (south of the cabbage field south of the Meat and Greet quest start)
- Go to the mace shop and buy a mace (there is a task to kill 5 enemies with a mace)
- Catch a Shrimp
- Cook a shrimp
